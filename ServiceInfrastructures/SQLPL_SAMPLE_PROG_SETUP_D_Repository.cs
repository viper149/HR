...
{
    public class SQLPL_SAMPLE_PROG_SETUP_D_Repository : BaseRepository<PL_BULK_PROG_SETUP_D>, IPL_SAMPLE_PROG_SETUP_D
    {
        public SQLPL_SAMPLE_PROG_SETUP_D_Repository(DenimDbContext denimDbContext) : base(denimDbContext)
        {
        }
