...
{
    public class SQLF_PR_WARPING_PROCESS_SW_DETAILS_Repository : BaseRepository<F_PR_WARPING_PROCESS_SW_DETAILS>, IF_PR_WARPING_PROCESS_SW_DETAILS
    {
        public SQLF_PR_WARPING_PROCESS_SW_DETAILS_Repository(DenimDbContext denimDbContext) : base(denimDbContext)
        {
        }
        public async Task<FPrWarpingProcessSwMasterViewModel> GetInitSoData(FPrWarpingProcessSwMasterViewModel prWarpingProcessSwMasterViewModel)
        {
            try
            {
                foreach (var item in prWarpingProcessSwMasterViewModel.FPrWarpingProcessSwDetailsList)
                {
