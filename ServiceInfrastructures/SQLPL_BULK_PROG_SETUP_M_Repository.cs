...
{
    public class SQLPL_BULK_PROG_SETUP_M_Repository : BaseRepository<PL_BULK_PROG_SETUP_M>, IPL_BULK_PROG_SETUP_M
    {
        private readonly IDataProtector _protector;

        public SQLPL_BULK_PROG_SETUP_M_Repository(DenimDbContext denimDbContext,
        ...
        public async Task<IEnumerable<PL_BULK_PROG_SETUP_M>> GetAllAsync()
        {
            try
            {
                var result = await DenimDbContext.PL_BULK_PROG_SETUP_M
                   ...
                   .Include(c => c.PL_BULK_PROG_SETUP_D)
                   .Where(c=>c.RndProductionOrder.ORDERNO!=null)
                   .Select(c => new PL_BULK_PROG_SETUP_M
                   {
                       BLK_PROGID = c.BLK_PROGID,
                       EncryptedId = _protector.Protect(c.BLK_PROGID.ToString()),
                       OPT1 = c.RndProductionOrder != null ? c.RndProductionOrder.SO != null ? c.RndProductionOrder.SO.SO_NO : "No Order No" : "No PO",
                       WARP_QTY = c.WARP_QTY,
                       ...
                       RndProductionOrder = new RND_PRODUCTION_ORDER
                       {
                           ...
                           OPT2 = c.RndProductionOrder != null ? c.RndProductionOrder.SO != null ? c.RndProductionOrder.SO.STYLE.FABCODENavigation.LOOM.LOOM_TYPE_NAME : "" : "",
                           OPT3 = c.RndProductionOrder != null ? c.RndProductionOrder.SO != null ? c.RndProductionOrder.SO.STYLE.FABCODENavigation.COLORCODENavigation.COLOR : "" : "",
