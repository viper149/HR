...
namespace DenimERP.Reports.Yarn_Store {
    ...
    public partial class RPT_YARN_ORDER_WISE_REPORT : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent() {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "DenimERP.Reports.Yarn_Store.RPT_YARN_ORDER_WISE_REPORT.repx");
            ...
            this.subreport2.ReportSource = new DenimERP.Reports.Yarn_Store.RPT_BULK_YARN_ORDER_WISE_HISTORY_SR_DETAILS();
            this.subreport1 = reportInitializer.GetControl<DevExpress.XtraReports.UI.XRSubreport>("subreport1");
            this.subreport1.ReportSource = new DenimERP.Reports.Yarn_Store.RPT_BULK_YARN_ORDER_WISE_HISTORY_YARN_DETAILS();
