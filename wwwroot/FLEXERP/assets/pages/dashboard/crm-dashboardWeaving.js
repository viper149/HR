...
$(document).ready(function () {
    ...
    jQuery.ajax({
        url: "/Chart/WeavingProductionList",
        type: "GET",
        contentType: 'application/json; charset=utf-8',
        success: function (resultData) {
            /*console.log(resultData);*/
            AmCharts.makeChart("weaving", {
                type: "serial",
                hideCredits: !0,
                theme: "light",
                ...
                graphs: [
                    {
                        ...
                        valueField: "dailyTotalWeavingProduction",
                        clustered: !1,
                        columnWidth: 0.5,
                    ...
                    },
                    {
                        ...
                        fillAlphas: 1,
                        type: "column",
                        title: "Airjet Production",
                        valueField: "dailyTotalAirjetProduction",
                        clustered: !1,
                        columnWidth: 0.3,
                        legendValueText: "[[value]] Yds",
                        balloonText: "[[title]]<br /><b style='font-size: 130%'>[[value]] Yds</b>",
                    },
                    {
                        ...
                        fillAlphas: 1,
                        type: "column",
                        title: "Rapier Production",
                        valueField: "dailyTotalRapierProduction",
                        clustered: !1,
                        columnWidth: 0.3,
                        legendValueText: "[[value]] Yds",
                        balloonText: "[[title]]<br /><b style='font-size: 130%'>[[value]] Yds</b>",
