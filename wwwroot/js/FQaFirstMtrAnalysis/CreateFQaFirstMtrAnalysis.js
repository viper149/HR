...
var actRatio = $("#FirstMtrAnalysisM_ACT_RATIO");
var actDent = $("#FirstMtrAnalysisM_ACT_DENT");
var actReed = $("#FirstMtrAnalysisM_ACT_REED");
...
function getBySet() {
    if (setId.val()) {
        ...
        $.get("/FirstMeterAnalysis/GetByAllSet", formData, function (data) {
            ...
            beamId.html("");
            beamId.append('<option value="" selected>Select Beam No.</option>');
            ...
            actReed.val(data.proG_.blK_PROG_.rndProductionOrder.so.style
                .fabcodeNavigation.reeD_COUNT);
            $("#stdDent").val(data.proG_.blK_PROG_.rndProductionOrder.so.style
                .fabcodeNavigation.dent);
            actDent.val(data.proG_.blK_PROG_.rndProductionOrder.so.style
                .fabcodeNavigation.dent);
