$(function () {
    ...
    $("#table").dataTable({
        ...
        columns: [
            { "data": "gradeid", "name": "GRADEID", "autoWidth": true, "visible": false },
            { "data": "gradE_NAME", "name": "GRADE_NAME", "autoWidth": true },
            { "data": "description", "name": "DESCRIPTION", "autoWidth": true },
            { "data": "remarks", "name": "REMARKS", "autoWidth": true },
            {
                "render": function (data, type, row) {
                    var editUrl = `<a href='/Grade/Edit?id=${row.encryptedId}' class='fa fa-edit fa-2x-custom text-warning'></a>`;
...
function deleteSwal(e, item) {
    ...
    swal({
        ...
        function (isConfirm) {
            if (isConfirm) {
                window.location = '/Grade/Delete/?id=' + item;
            }
        });
}