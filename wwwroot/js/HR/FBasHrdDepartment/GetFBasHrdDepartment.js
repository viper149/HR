$(function () {
    ...
    $("#table").dataTable({
        ...
        columns: [
            ...
            { "data": "deptnamE_BN", "name": "DEPTNAME_BN", "autoWidth": true },
            { "data": "location.loC_NAME", "name": "LOCATION", "autoWidth": true },
            { "data": "description", "name": "DESCRIPTION", "autoWidth": true },
            { "data": "remarks", "name": "REMARKS", "autoWidth": true },
            {
                "render": function (data, type, row) {
                    var editUrl = `<a href='/Department/Edit?id=${row.encryptedId}' class='fa fa-edit fa-2x-custom text-warning'></a>`;
...
function deleteSwal(e, item) {
    ...
    swal({
        ...
        function (isConfirm) {
            if (isConfirm) {
                window.location = '/Department/Delete/?id=' + item;
            }
        });
}