...
$(function () {
    $("#table").dataTable({
        ...
        ajax: {
            "async": "true",
            "url": "/FPrReconeMaster/GetTableData",
            "type": "POST",
            "datatype": "json"
        },
        columnDefs: [
        ...
        columns: [
            ...
            { "data": "seT_NO", "name": "SET_NO", "autoWidth": true },
            { "data": "nO_OF_BALL", "name": "NO_OF_BALL", "autoWidth": true },
            { "data": "warP_LENGTH", "name": "WARP_LENGTH", "autoWidth": true },
            { "data": "warP_RATIO", "name": "WARP_RATIO", "autoWidth": true },
            { "data": "converted", "name": "CONVERTED", "autoWidth": true },
