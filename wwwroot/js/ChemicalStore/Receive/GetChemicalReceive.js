...
$(function () {
    $("#table").dataTable({
        ...
        ajax: {
            "async": "true",
            "url": "/ChemicalReceive/GetTableData",
            "type": "POST",
            "datatype": "json"
        },
        columnDefs: [
        ...
        columns: [
            { "data": "chemrcvid", "name": "CHEMRCVID", "autoWidth": true },
            {
            ...
            { "data": "comImpInvoiceinfo.invno", "name": "ComImpInvoiceinfo.INVNO", "autoWidth": true },
            ...
            { "data": "cnf.cnfname", "name": "CNF.CNFNAME", "autoWidth": true },
            { "data": "vehicaL_NO", "name": "VEHICAL_NO", "autoWidth": true },
            { "data": "remarks", "name": "REMARKS", "autoWidth": true },
            {
                "render": function (data, type, row) {

                    var detailsUrl = `<a href='/ChemicalReceive/Details/${row.encryptedId}' class='fa fa-info-circle fa-2x-custom text-primary'></a>`;
                    var editUrl = `<a href='/ChemicalReceive/Edit/${row.encryptedId}' class='fa fa-edit fa-2x-custom text-warning'></a>`;
