        ...
        columns: [
            ...
            { "data": "remarks", "name": "Remarks", "autoWidth": true },
            {
                "render": function (data, type, row) {
                    return "<a href='/ComTenor/EditTenor?tId=" + row.encryptedId + "' class='fa fa-edit fa-2x-custom text-warning mr-2'></a>" +
...
function deleteSwal(e, item) {
    ...
    swal({
        ...
        function (isConfirm) {
            if (isConfirm) {
                window.location = "/ComTenor/EditTenor/?tId=" + item;
            }
        });
}