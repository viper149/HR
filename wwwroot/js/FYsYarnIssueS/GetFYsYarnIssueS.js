    ...
    $("#table").dataTable({
        ...
        columns: [
            ...
            { "data": "issueto", "name": "ISSUETO", "autoWidth": true },
            {
                ...
                "render": function (data, type, row) {
                    return row.ysrId != null ? row.ysr.ysrno : "";
                }
            },
            ...
            { "data": "remarks", "name": "REMARKS", "autoWidth": true },
            {
                "render": function (data, type, row) {
                    var editUrl =
                        `<a href='/YarnIssueS/Edit/${row.encryptedId}' class='fa fa-edit fa-2x-custom text-warning'></a>`;
                    var detailsUrl = `<a href='/YarnIssueS/Details/${row.encryptedId}' class='fa fa-info-circle fa-2x-custom text-primary'></a> `;
