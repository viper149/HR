$(function () {
    ...
    $("#table").dataTable({
        ...
        ajax: {
            "async": "true",
            "url": "/FFsWastageIssue/GetTableData",
            "type": "POST",
            "datatype": "json"
        },
        columnDefs: [{
        ...
        columns: [
            ...
            {
                "data": "widate", "name": "WIDATE", "autoWidth": true,
                "render": function (data, type, row) {
                    return data !== null ? moment(data).format(row.dateFormat) : "N/A";
                }
            },
            { "data": "fFsWastageParty.pname", "name": "PNAME", "autoWidth": true },
            ...
            { "data": "remarks", "name": "REMARKS", "autoWidth": true },
            {
                "render": function (data, type, row) {
                    ...
                    var editUrl = `<a href='/FFsWastageIssue/EditFFsWastageIssueInfo?fwiId=${row.encryptedId}' class='fa fa-edit fa-lg text-warning'></a>`;
