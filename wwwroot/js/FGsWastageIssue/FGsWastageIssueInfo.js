$(function () {
    ...
    $("#table").dataTable({
        ...
        ajax: {
            "async": "true",
            "url": "/FGsWastageIssue/GetTableData",
            "type": "POST",
            "datatype": "json"
        },
        columnDefs: [{
        ...
        columns: [
            ...
            { "data": "fGsWastageParty.pname", "name": "PNAME", "autoWidth": true },
            ...
            { "data": "remarks", "name": "REMARKS", "autoWidth": true },
            {
                "render": function (data, type, row) {
                    ...
                    var editUrl = `<a href='/FGsWastageIssue/EditFGsWastageIssueInfo?wiId=${row.encryptedId}' class='fa fa-edit fa-lg text-warning'></a>`;
