$(function () {
    ...
    $("#table").dataTable({
        ...
        ajax: {
            "async": "true",
            "url": "/FGsWastageReceive/GetTableData",
            "type": "POST",
            "datatype": "json"
        },
        columnDefs: [{
        ...
        columns: [
            ...
            { "data": "remarks", "name": "REMARKS", "autoWidth": true },
            {
                "render": function (data, type, row) {
                    ...
                    var editUrl = `<a href='/FGsWastageReceive/EditFGsWastageReceiveInfo?wrId=${row.encryptedId}' class='fa fa-edit fa-lg text-warning'></a>`;
