...
$(function () {
    $("#table").dataTable({
        ...
        ajax: {
            "async": "true",
            "url": "/FPrInspectionFabricDispatch/GetTableData",
            "type": "POST",
            "datatype": "json"
        },
        columnDefs: [
        ...
        columns: [
            { "data": "did", "name": "DID", "autoWidth": true , "visible": false},
            {
                "data": "ddate",
                "name": "DDATE",
                "autoWidth": true,
            ...
            { "data": "nO_ROLL", "name": "NO_ROLL", "autoWidth": true },
            { "data": "remarks", "name": "REMARKS", "autoWidth": true },
            {
                "render": function (data, type, row) {
                    return `<a href='/FPrInspectionFabricDispatch/DetailsRollReceive?id=${row.encryptedId
