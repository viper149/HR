...
{
    public class FPrInspectionProcessController : Controller
    {
        ...
        public FPrInspectionProcessController(IDataProtectionProvider dataProtectionProvider,
        ...
        {
            return await _fPrInspectionProcessMaster.GetInitObjects(prInspectionProcessViewModel);
        }
