...
using DenimERP.Reports.Fabric_Store;
using DenimERP.Views.FFabricStore;

namespace DenimERP.Views.FPrInspectionProcess.Reports {
    
    public partial class RPT_INS_Style_wise_production : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent() {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "DenimERP.Views.FPrInspectionProcess.Reports.RPT_INS_Style_wise_production.repx");
            ...
            this.subreport1.ReportSource = new rpyDeliveryChallan();
