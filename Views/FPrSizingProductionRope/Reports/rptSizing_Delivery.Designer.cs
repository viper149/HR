...
namespace DenimERP.Views.FPrSizingProductionRope.Reports {
    
    public partial class rptSizing_Delivery : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent(string progNo) {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "DenimERP.Views.FPrSizingProductionRope.Reports.rptSizing_Delivery.repx");
