...
namespace DenimERP.Views.FDyeingProcessRopeMaster.Reports {
    
    public partial class rptRopeDyeing_Delivery : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent(string groupNo) {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "DenimERP.Views.FDyeingProcessRopeMaster.Reports.rptRopeDyeing_Delivery.repx");
