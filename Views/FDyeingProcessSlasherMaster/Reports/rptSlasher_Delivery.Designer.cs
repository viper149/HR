...
namespace DenimERP.Views.FDyeingProcessSlasherMaster.Reports {
    
    public partial class rptSlasher_Delivery : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent(string PROG_NO) {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "DenimERP.Views.FDyeingProcessSlasherMaster.Reports.rptSlasher_Delivery.repx");
