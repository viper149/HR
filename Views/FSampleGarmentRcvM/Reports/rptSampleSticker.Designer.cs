...
namespace DenimERP.Views.FSampleGarmentRcvM.Reports {
    
    public partial class rptSampleSticker : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent(string barcode) {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "DenimERP.Views.FSampleGarmentRcvM.Reports.rptSampleSticker.repx");
