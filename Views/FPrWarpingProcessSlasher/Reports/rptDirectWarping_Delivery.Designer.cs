...
namespace DenimERP.Views.FPrWarpingProcessSlasher.Reports {
    
    public partial class rptDirectWarping_Delivery : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent(string setNo) {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "DenimERP.Views.FPrWarpingProcessSlasher.Reports.rptDirectWarping_Delivery.repx");
